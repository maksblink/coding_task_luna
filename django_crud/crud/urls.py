...
from .views import HydroponicSystemViewSet, MeasurementViewSet, SensorViewSet, home, update_hydroponic_system, delete_hydroponic_system, MeasurementListView, add_hydroponic_system, hydroponic_system_detail, add_measurement
